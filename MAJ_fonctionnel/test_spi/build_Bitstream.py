...
p.addFile('./SPI_PERIPHERAL.vhdl')
p.addFile('./SPI_CONTROLER.vhdl')
p.addFile('./ram.vhd')
p.addFile('./wishbone_driver.vhdl')
p.addFile('./../../OpenCores/test_SPI/simple_spi_top.v')
p.addFile('./../../OpenCores/test_SPI/fifo4.v')
p.addFile('./../../OpenCores/test_SPI/timescale.v')
...
p.setTopCellName('SPI_CONTROLER')
...
res = p.generateBitstream('./test_spi.nxb')
if res == True :
