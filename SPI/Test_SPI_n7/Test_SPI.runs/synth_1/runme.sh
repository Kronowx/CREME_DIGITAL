...
HD_PWD='D:/1005_creme/CREME_DIGITAL-TEAM_SPI/SPI/Test_SPI_n7/Test_SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Histogram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Histogram.tcl
