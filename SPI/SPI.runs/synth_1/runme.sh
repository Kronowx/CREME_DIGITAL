...
HD_PWD='G:/nosave/Nanosat/SPI/SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_CONTROLER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_CONTROLER.tcl
