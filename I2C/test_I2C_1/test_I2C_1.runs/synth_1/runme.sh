...
HD_PWD='D:/CREME_DIGITAL/I2C/test_I2C_1/test_I2C_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_PERIPHERAL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2C_PERIPHERAL.tcl
