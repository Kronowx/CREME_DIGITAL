...
HD_PWD='D:/CREME_DIGITAL/I2C/test_I2C_1/test_I2C_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_CONTROLER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2C_CONTROLER.tcl -notrace
